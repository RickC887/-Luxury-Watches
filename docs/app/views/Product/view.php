                ...
                <div class="w_sidebar">
                    <section  class="sky-form">
                        ...
                        <div class="row1 scroll-pane">
                            <div class="col col-4">
                                <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Всі аксесуари</label>
                            </div>
                            <div class="col col-4">
                                <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Жіночі годинники</label>
                                <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Дитячі годинники</label>
                                <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Чоловічі годинники</label>
                            </div>
                        </div>
                    </section>
                    <section  class="sky-form">
