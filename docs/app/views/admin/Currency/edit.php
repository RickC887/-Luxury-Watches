                ...
                <form method="post" action="<?= ADMIN ?>/currency/edit" role="form" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="symbol_left">Символ ліворуч</label>
                            <input type="text" name="symbol_left" class="form-control" id="symbol_left" placeholder="Символ ліворуч" value="<?= h($currency->symbol_left) ?>">
                        </div>
                        <div class="form-group">
                            <label for="symbol_right">Символ праворуч</label>
                            <input type="text" name="symbol_right" class="form-control" id="symbol_right" placeholder="Символ праворуч" value="<?= h($currency->symbol_right) ?>">
                        </div>
                        <div class="form-group has-feedback">
                            <label for="value">Значення</label>
                            <input type="text" name="value" class="form-control" id="value" placeholder="Значение" pattern="^[0-9.]{1,}$" required data-error="Допускаються цифри та десяткова крапка" value="<?= $currency->value ?>">
