                ...
                <form action="<?=ADMIN;?>/currency/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="symbol_left" class="form-control" id="symbol_left" placeholder="Символ ліворуч">
                        </div>
                        <div class="form-group">
                            <label for="symbol_right">Символ праворуч</label>
                            <input type="text" name="symbol_right" class="form-control" id="symbol_right" placeholder="Символ праворуч">
                        </div>
                        <div class="form-group has-feedback">
                            <label for="value">Значення</label>
                            <input type="text" name="value" class="form-control" id="value" placeholder="Значення" required data-error="Допускаються цифри та десяткова крапка" pattern="^[0-9.]{1,}$">
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
